...
```{r}
# Load functions
source("processing/functions_v2.R", encoding = "UTF-8")
```
...
fit <- parLapply(cl, models, function(model) {
  ...
  source("processing/functions_v2.R", encoding = "UTF-8") # load function for text object
...
kableExtra::kable(gofdt, digits = 3,
                  caption = "Fit measueres for RI-CLPM models between justice and violence") %>%   kableExtra::kable_styling(
