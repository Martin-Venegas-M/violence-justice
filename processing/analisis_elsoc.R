...
reg_sig(
  estimate_riclpm(text_riclpm_v2("brecha_perc", "f05_04", c(1:7), inv_preds = c("m0_edad_w01", "m0_sexo_w01", "m01_w01", "c15_w01"), constrain = TRUE)),
  "brecha_perc",
  "f05_04"
) %>%
  filter(
...
reg_sig(
  estimate_riclpm(text_riclpm_v2("c18_11", "f05_04", c(1:7), inv_preds = c("m0_edad_w01", "m0_sexo_w01", "m01_w01", "c15_w01"), constrain = TRUE)),
  "c18_11",
  "f05_04"
) %>%
  filter(
...
# 7.1 Moderación con cuatro grupos ---------------------------------------
text_moderation4 <- "
